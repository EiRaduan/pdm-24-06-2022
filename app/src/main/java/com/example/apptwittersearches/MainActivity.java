package com.example.apptwittersearches;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void removerBusca(String tagRemove) {
        AlertDialog.Builder confirmBuilder = new AlertDialog.Builder(MainActivity.this);
        confirmBuilder.setMessage(getString(R.string.confirmMessage, tags));
        ...
        confirmBuilder.setPositiveButton("Sim", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                preferencesEditor.remove(tagRemove);
